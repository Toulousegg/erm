...
@contacts_router.post("/add", dependencies=[Depends(require_module("contacts"))])
...
@contacts_router.put("/edit/{contactId}", dependencies=[Depends(require_module("contacts"))])
...
@contacts_router.delete("/delete/{contactId}", dependencies=[Depends(require_module("contacts"))])
@limiter.limit("7/minute")
...
@contacts_router.get("/", dependencies=[Depends(require_module("contacts"))])
