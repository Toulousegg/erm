...
Revision ID: c38b54e0378a
Revises: 2d9220af34ba
Create Date: 2026-07-23 18:57:39.065669
...
revision: str = 'c38b54e0378a'
down_revision: Union[str, Sequence[str], None] = '2d9220af34ba'
...
def upgrade() -> None:
    ...
    op.alter_column('inventory', 'code',
               existing_type=sa.VARCHAR(),
               nullable=False)
    op.add_column('moduls', sa.Column('icon_aside', sa.String(), nullable=True))
    op.drop_index(op.f('ix_moduls_icon'), table_name='moduls')
    op.create_index(op.f('ix_moduls_icon_aside'), 'moduls', ['icon_aside'], unique=False)
...
def downgrade() -> None:
    """Downgrade schema."""
    # ### commands auto generated by Alembic - please adjust! ###
    op.add_column('moduls', sa.Column('icon', sa.VARCHAR(), autoincrement=False, nullable=True))
    op.drop_index(op.f('ix_moduls_icon_aside'), table_name='moduls')
    op.create_index(op.f('ix_moduls_icon'), 'moduls', ['icon'], unique=False)
    op.drop_column('moduls', 'icon_aside')
    op.alter_column('inventory', 'code',
               existing_type=sa.VARCHAR(),
               nullable=True)
