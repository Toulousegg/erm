"""edit inventory models

Revision ID: 2f1c66c9f0a0
Revises: 
Create Date: 2026-02-17 23:38:37.095293
...
def downgrade() -> None:
    ...
    sa.ForeignKeyConstraint(['owner_id'], ['users.id'], name=op.f('inventory_owner_id_fkey')),
