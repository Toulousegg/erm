...
Revision ID: 6b709406d879
Revises: 8d0f0d5c4f21
Create Date: 2026-07-03 08:35:05.244001
...
revision: str = '6b709406d879'
down_revision: Union[str, Sequence[str], None] = '8d0f0d5c4f21'
...
def upgrade() -> None:
    ...
    op.alter_column('moduls', 'price',
               existing_type=postgresql.DOUBLE_PRECISION(precision=53),
               type_=sa.Integer(),
               existing_nullable=False)
    op.create_unique_constraint('uq_company_module', 'moduls_companies', ['company_id', 'modul_id'])
...
def downgrade() -> None:
    """Downgrade schema."""
    # ### commands auto generated by Alembic - please adjust! ###
    op.drop_constraint('uq_company_module', 'moduls_companies', type_='unique')
    op.alter_column('moduls', 'price',
               existing_type=sa.Integer(),
               type_=postgresql.DOUBLE_PRECISION(precision=53),
               existing_nullable=False)
    op.add_column('companies', sa.Column('plan', sa.VARCHAR(), autoincrement=False, nullable=False))
