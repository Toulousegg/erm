...
Revision ID: a1f875ae8c5c
Revises: 
Create Date: 2026-07-08 16:49:06.116627
...
def upgrade() -> None:
    ...
    op.add_column('moduls', sa.Column('external_id', sa.String(), nullable=True))
    op.create_index(op.f('ix_moduls_external_id'), 'moduls', ['external_id'], unique=False)
...
def downgrade() -> None:
    """Downgrade schema."""
    # ### commands auto generated by Alembic - please adjust! ###
    op.drop_index(op.f('ix_moduls_external_id'), table_name='moduls')
    op.drop_column('moduls', 'external_id')
