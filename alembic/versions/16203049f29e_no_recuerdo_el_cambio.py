"""no recuerdo el cambio

Revision ID: 16203049f29e
Revises: 1a13d62b285c
Create Date: 2026-07-17 15:35:58.166433
...
revision: str = '16203049f29e'
down_revision: Union[str, Sequence[str], None] = '1a13d62b285c'
...
def upgrade() -> None:
    ...
    op.add_column('users', sa.Column('barcode', sa.String(), nullable=True))
