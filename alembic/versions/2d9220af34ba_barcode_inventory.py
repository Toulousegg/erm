...
Revision ID: 2d9220af34ba
Revises: 840effa772d3
Create Date: 2026-07-20 14:41:05.703462
...
revision: str = '2d9220af34ba'
down_revision: Union[str, Sequence[str], None] = '840effa772d3'
...
def upgrade() -> None:
    ...
    op.add_column('inventory', sa.Column('code', sa.String(), nullable=True))
